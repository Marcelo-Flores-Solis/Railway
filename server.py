    ...
    def do_GET(self):
        ...
        try:
            ...
            if path == '/admin':
                ...
                content = content.replace('{TOTAL_MENSAJES}', str(stats['total']))
                content = content.replace('{TOTAL_USUARIOS}', str(stats['usuarios']))
                content = content.replace('{ULTIMO_MENSAJE}', str(stats['ultimo']))
